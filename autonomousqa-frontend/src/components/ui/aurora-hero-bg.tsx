  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(ellipse at center, transparent 0%, ${isDark ? 'rgba(9, 9, 11, 0.8)' : 'rgba(255, 255, 255, 0.8)'} 100%)`,
        }}
        aria-hidden="true"
      />
      ...
      {children ? (
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
          ...
          >
            {/* Animated Title */}
            {title && (
              <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-bold mb-8 tracking-tight" style={{ lineHeight: '1.2' }}>
