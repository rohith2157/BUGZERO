...
export function WarpBackground({
    ...
    return (
        <div className={cn("relative rounded-xl border p-12 flex flex-col", className)} style={{ background: 'var(--color-bg-secondary)', ...props.style }} {...props}>
            <div
                style={{
            ...
            <div className="relative flex-1 w-full flex flex-col">{children}</div>
        </div>
    );
}
