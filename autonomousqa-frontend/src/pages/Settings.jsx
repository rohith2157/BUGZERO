                                ...
                                <div key={m.id} style={{
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                        ...
                                        <span style={{
                                            ...
                                            background: m.role === 'Owner' ? 'rgba(139,92,246,0.1)' : m.role === 'Admin' ? 'rgba(212,168,83,0.08)' : 'var(--color-bg-secondary)',
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                                        ...
                                        <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}
                                            ...
                                            style={{
                                                ...
                                                background: copiedKeyId === key.id ? 'rgba(16,185,129,0.1)' : 'var(--color-bg-secondary)', border: 'none',
                                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                    ...
                    {loadingBilling ? (
                        ...
                        <div className="glass-card" style={{ padding: '28px', marginBottom: 20, maxWidth: 600 }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 20 }}>
                                <div style={{ padding: '12px', borderRadius: 'var(--radius-md)', background: 'var(--color-bg-secondary)' }}>
